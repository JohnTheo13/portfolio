...
const test = () => (
  describe('Fields', () => {
    let wrapper
    beforeEach(() => {
      wrapper = mount(<Field placeholder="stories" label="Label test" />)
    })
    ...
    it('should render an Icon', () => {
      wrapper.setProps({ icon: '/images/car.png' })
      expect(wrapper.childAt(0).props().children[0].props.src).to.equal('/images/car.png')
    })
