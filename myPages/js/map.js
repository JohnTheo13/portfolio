// JavaScript Document
app.controller("MapCtrl", ["$scope","getMapData","NgMap", function($scope,getMapData,NgMap) {
	
	getMapData.success(function(data){
	var arrAvailable = [];
	var arrNot = [];
	  ...
	  for (var i = 0; i< arrAvailable.length; i++){
	  	arrAvailable[i].iconUrl="././images/green-traffic-light.gif";
	  }																		//add the related trafic-light icon as property
	  
	  for (var i = 0; i< arrNot.length; i++){
	  	arrNot[i].iconUrl="././images/red-traffic-light.gif";
	  }
